/***************************************************************************
 *                 GWcsMOL.hpp - Mollweide's projection class              *
 * ----------------------------------------------------------------------- *
 ...
 * @brief Mollweide's projection class definition
 *
 * This class implements the Mollweide projection for the World Coordinate
 * System.
 ***************************************************************************/
 ...
 *
 * @return String containing the class name ("GWcsMOL").
 ***************************************************************************/
inline
std::string GWcsMOL::classname(void) const
{
    return ("GWcsMOL");
}
 ...
 *
 * Returns the projection code "MOL".
 ***************************************************************************/
inline
std::string GWcsMOL::code(void) const
{
    return "MOL";
}
 ...
 ***************************************************************************/
inline
std::string GWcsMOL::name(void) const
{
    return "Mollweide";
}
