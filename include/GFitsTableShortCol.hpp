...
public:
    ...
    GFitsTableShortCol(const std::string& name, const int& nrows,
                       const int& size = 1);
 ...
 *
 * @return String containing the class name ("GFitsTableShortCol").
 ***************************************************************************/
inline
std::string GFitsTableShortCol::classname(void) const
{
    return ("GFitsTableShortCol");
}
 ...
 ***************************************************************************/
inline
bool GFitsTableShortCol::is_loaded(void) const
{
    return (m_data != NULL);
}
