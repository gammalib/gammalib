/***************************************************************************
 *         GSkyRegion.hpp - circular sky region class         *
 * ----------------------------------------------------------------------- *
 *             copyright (C) 2009-2013 by Michael Mayer                  *
 * ----------------------------------------------------------------------- *
 *                                                                         *
...
* The sky region is defined by an array of parameters, the meaning of
* which is specific to the derived class where the region type or shape is defined.
