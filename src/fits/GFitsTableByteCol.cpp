 ...
 ***************************************************************************/
void GFitsTableByteCol::insert(const int& row, const int& nrows)
{
 ...
 * will be loaded into memory.
 ***************************************************************************/
void GFitsTableByteCol::remove(const int& row, const int& nrows)
{
    // Make sure that row is valid
    if (row < 0 || row >= m_length) {
 ...
 ***************************************************************************/
void GFitsTableByteCol::resize_data(const int& index, const int& number)
{
    ...
    if (number != 0) {
        ...
        if (number < 0) {
            ...
            unsigned char* dst  = m_data + index;
            unsigned char* src  = m_data + left;
            int    num  = m_size - left;
            for (int i = 0; i < num; ++i) {
                *dst++ = *src++;
            }
