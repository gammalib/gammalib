 ...
 ***************************************************************************/
/**
 * @file GFitsTableByteCol.cpp
 * @brief FITS table byte column class implementation
 ...
 * @brief Constructor
 ***************************************************************************/
GFitsTableByteCol::GFitsTableByteCol(void) : GFitsTableCol()
{
 ...
 ***************************************************************************/
GFitsTableByteCol::GFitsTableByteCol(const std::string& name,
                                     const int&         length,
                                     const int&         size)
 ...
 ***************************************************************************/
GFitsTableByteCol::GFitsTableByteCol(const GFitsTableByteCol& column)
 ...
 * @brief Destructor
 ***************************************************************************/
GFitsTableByteCol::~GFitsTableByteCol(void)
{
    // Free members
    free_members();
 ...
 * @param[in] column Table column.
 ***************************************************************************/
GFitsTableByteCol& GFitsTableByteCol::operator= (const GFitsTableByteCol& column)
{
 ...
 ***************************************************************************/
unsigned char& GFitsTableByteCol::operator() (const int& row, const int& inx)
{
...
const unsigned char& GFitsTableByteCol::operator() (const int& row, const int& inx) const
{
    // If data are not available then load them now
    if (m_data == NULL) {
        const_cast<GFitsTableByteCol*>(this)->fetch_data();
    }
 ...
 ***************************************************************************/
void GFitsTableByteCol::clear(void)
{
 ...
 * @brief Clone column
 ***************************************************************************/
GFitsTableByteCol* GFitsTableByteCol::clone(void) const
{
    return new GFitsTableByteCol(*this);
}
 ...
 ***************************************************************************/
std::string GFitsTableByteCol::string(const int& row, const int& inx) const
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();

    // Convert unsigned char into string
 ...
 ***************************************************************************/
double GFitsTableByteCol::real(const int& row, const int& inx) const
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();

    // Convert unsigned char into double
 ...
 ***************************************************************************/
int GFitsTableByteCol::integer(const int& row, const int& inx) const
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();
 ...
 ***************************************************************************/
void GFitsTableByteCol::insert(const int& rownum, const int& nrows)
{
 ...
 * will be loaded into memory.
 ***************************************************************************/
void GFitsTableByteCol::remove(const int& rownum, const int& nrows)
{
    // Make sure that rownum is valid
    if (rownum < 0 || rownum >= m_length) {
 ...
 ***************************************************************************/
void GFitsTableByteCol::nulval(const unsigned char* value)
{
    // Allocate nul value
    alloc_nulval(value);
 ...
 ***************************************************************************/
void GFitsTableByteCol::init_members(void)
{
    // Initialise members
    m_type   = __TBYTE;
    m_data   = NULL;
...
void GFitsTableByteCol::copy_members(const GFitsTableByteCol& column)
{
    ...
    if (not_loaded) {
        const_cast<GFitsTableByteCol*>(&column)->fetch_data();
    }
    ...
    if (not_loaded) {
        const_cast<GFitsTableByteCol*>(&column)->release_data();
    }
    #endif
 ...
 ***************************************************************************/
void GFitsTableByteCol::free_members(void)
{
    // Free memory
    if (m_data   != NULL) delete [] m_data;
 ...
 ***************************************************************************/
std::string GFitsTableByteCol::ascii_format(void) const
{
 ...
 ***************************************************************************/
void GFitsTableByteCol::alloc_data(void)
{
 ...
 ***************************************************************************/
void GFitsTableByteCol::fetch_data(void) const
{
    // Save column (circumvent const correctness)
    const_cast<GFitsTableByteCol*>(this)->load_column();
 ...
 * copy constructor.
 ***************************************************************************/
void GFitsTableByteCol::copy_data(const GFitsTableCol& column)
{
    // Type-cast to the correct column type
    const GFitsTableByteCol* ptr = static_cast<const GFitsTableByteCol*>(&column);
 ...
 ***************************************************************************/
void GFitsTableByteCol::release_data(void)
{
    // Free any existing memory
    if (m_data != NULL) delete [] m_data;
 ...
 ***************************************************************************/
void GFitsTableByteCol::alloc_nulval(const unsigned char* value)
{
    // Free any existing memory
    if (m_nulval != NULL) delete m_nulval;
 ...
 ***************************************************************************/
void GFitsTableByteCol::init_data(void)
{
