 ...
 * @brief Long integer FITS image class implementation
 ...
 ***************************************************************************/
GFitsImageLong::GFitsImageLong(void) : GFitsImage()
{
 ...
 ***************************************************************************/
GFitsImageLong::GFitsImageLong(const int& nx, const long* pixels) :
 ...
 ***************************************************************************/
GFitsImageLong::GFitsImageLong(const int& nx, const int& ny, const long* pixels) :
 ...
 ***************************************************************************/
GFitsImageLong::GFitsImageLong(const int& nx, const int& ny, const int& nz,
                               const long* pixels) :
 ...
 ***************************************************************************/
GFitsImageLong::GFitsImageLong(const int& nx, const int& ny, const int& nz,
                               const int& nt, const long* pixels) :
 ...
 * integer image.
 ***************************************************************************/
GFitsImageLong::GFitsImageLong(const GFitsImage& image) :
                GFitsImage(image)
{
    // Initialise class members
    init_members();
 ...
 * @param[in] image FITS image.
 ***************************************************************************/
GFitsImageLong::GFitsImageLong(const GFitsImageLong& image) :
                GFitsImage(image)
{
    // Initialise class members
    init_members();
 ...
 * @brief Destructor
 ***************************************************************************/
GFitsImageLong::~GFitsImageLong(void)
{
    // Free members
    free_members();
 ...
 * @param[in] image FITS image.
 ***************************************************************************/
GFitsImageLong& GFitsImageLong::operator=(const GFitsImageLong& image)
{
 ...
 ***************************************************************************/
void GFitsImageLong::clear(void)
{
 ...
 ***************************************************************************/
GFitsImageLong* GFitsImageLong::clone(void) const
{
    // Clone this image
    return new GFitsImageLong(*this);
}
 ...
 ***************************************************************************/
double GFitsImageLong::pixel(const int& ix) const
{
    // Return pixel value
 ...
 * value. This method performs range checking.
 ***************************************************************************/
double GFitsImageLong::pixel(const int& ix, const int& iy) const
{
    // Return pixel value
 ...
 * value. This method performs range checking.
 ***************************************************************************/
double GFitsImageLong::pixel(const int& ix, const int& iy, const int& iz) const
{
    // Return pixel value
 ...
 * value. This method performs range checking.
 ***************************************************************************/
double GFitsImageLong::pixel(const int& ix, const int& iy, const int& iz,
                              const int& it) const
{
    // Return pixel value
 ...
 ***************************************************************************/
int GFitsImageLong::type(void) const
{
    // Return type
    return __TLONG;
}
 ...
 ***************************************************************************/
void GFitsImageLong::init_members(void)
{
    // Initialise members
    m_bitpix = G_BITPIX;
    m_pixels = NULL;
 ...
 ***************************************************************************/
void GFitsImageLong::copy_members(const GFitsImageLong& image)
{
 ...
 ***************************************************************************/
void GFitsImageLong::free_members(void)
{
    // Free memory
 ...
 * @brief Allocate data
 ***************************************************************************/
void GFitsImageLong::alloc_data(void)
{
 ...
 ***************************************************************************/
void GFitsImageLong::init_data(void)
{
 ...
 * @brief Release data
 ***************************************************************************/
void GFitsImageLong::release_data(void)
{
 ...
 * constructors.
 ***************************************************************************/
void GFitsImageLong::construct_data(const long* pixels)
{
