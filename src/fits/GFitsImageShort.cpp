 ...
 ***************************************************************************/
/**
 * @file GFitsImageShort.cpp
 * @brief Short integer FITS image class implementation
 ...
 ***************************************************************************/
GFitsImageShort::GFitsImageShort(const int& nx, const short* pixels) :
 ...
 ***************************************************************************/
GFitsImageShort::GFitsImageShort(const int& nx, const int& ny,
                                 const short* pixels) :
 ...
 ***************************************************************************/
GFitsImageShort::GFitsImageShort(const int& nx, const int& ny, const int& nz,
                                 const short* pixels) :
 ...
 ***************************************************************************/
GFitsImageShort::GFitsImageShort(const int& nx, const int& ny, const int& nz,
                                 const int& nt, const short* pixels) :
 ...
 *
 * This constructor performs the conversion of any image type into a short
 * integer image.
 ***************************************************************************/
GFitsImageShort::GFitsImageShort(const GFitsImage& image) :
                 GFitsImage(image)
{
    // Initialise class members
    init_members();
    ...
    if (m_num_pixels > 0) {
        ...
        for (int i = 0; i < m_num_pixels; ++i) {
            m_pixels[i] = (short)image.pixel(i);
        }
    }
 ...
 * checking and image dimension verification is required.
 ***************************************************************************/
short& GFitsImageShort::operator()(const int& ix, const int& iy, const int& iz)
{
    // Load data
    load_data();
 ...
 ***************************************************************************/
void GFitsImageShort::clear(void)
{
...
void GFitsImageShort::copy_members(const GFitsImageShort& image)
{
    ...
    if (not_loaded) {
        const_cast<GFitsImageShort*>(&image)->fetch_data();
    }
    ...
    if (not_loaded) {
        const_cast<GFitsImageShort*>(&image)->release_data();
    }
    #endif
 ...
 ***************************************************************************/
void GFitsImageShort::load_data(void) const
{
    // If image pixels are not available then fetch them now.
    if (m_pixels == NULL) {
        const_cast<GFitsImageShort*>(this)->fetch_data();
    }
