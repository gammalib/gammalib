 ...
 ***************************************************************************/
GFitsImageFloat::GFitsImageFloat(const std::vector<int>& naxes,
                                 const float*            pixels) :
 ...
 * @brief Destructor
 ***************************************************************************/
GFitsImageFloat::~GFitsImageFloat(void)
{
    // Free members
    free_members();
 ...
 ***************************************************************************/
void GFitsImageFloat::clear(void)
{
 ...
 ***************************************************************************/
GFitsImageFloat* GFitsImageFloat::clone(void) const
{
    // Clone this image
    return new GFitsImageFloat(*this);
}
 ...
 ***************************************************************************/
double GFitsImageFloat::pixel(const int& ix) const
{
    // Return pixel value
 ...
 * value. This method performs range checking.
 ***************************************************************************/
double GFitsImageFloat::pixel(const int& ix, const int& iy) const
{
    // Return pixel value
 ...
 * value. This method performs range checking.
 ***************************************************************************/
double GFitsImageFloat::pixel(const int& ix, const int& iy, const int& iz) const
{
    // Return pixel value
 ...
 * value. This method performs range checking.
 ***************************************************************************/
double GFitsImageFloat::pixel(const int& ix, const int& iy, const int& iz,
                              const int& it) const
{
    // Return pixel value
 ...
 ***************************************************************************/
void GFitsImageFloat::init_members(void)
{
    // Initialise members
    m_bitpix = G_BITPIX;
    m_pixels = NULL;
 ...
 ***************************************************************************/
void GFitsImageFloat::copy_members(const GFitsImageFloat& image)
{
 ...
 ***************************************************************************/
void GFitsImageFloat::free_members(void)
{
    // Free memory
 ...
 * @brief Allocate data
 ***************************************************************************/
void GFitsImageFloat::alloc_data(void)
{
 ...
 ***************************************************************************/
void GFitsImageFloat::init_data(void)
{
 ...
 * @brief Release data
 ***************************************************************************/
void GFitsImageFloat::release_data(void)
{
 ...
 * constructors.
 ***************************************************************************/
void GFitsImageFloat::construct_data(const float* pixels)
{
