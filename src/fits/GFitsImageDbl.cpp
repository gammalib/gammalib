 ...
 ***************************************************************************/
GFitsImageDbl::GFitsImageDbl(int naxis, const int* naxes) : GFitsImage(naxis, naxes)
{
    // Initialise class members for clean destruction
    init_members();
 ...
 * CHANGED !!!!
 ***************************************************************************/
void GFitsImageDbl::set_nullval(const double* value)
{
