 ...
 ***************************************************************************/
void GFitsTableShortCol::fetch_data(void) const
{
 ...
 * copy constructor.
 ***************************************************************************/
void GFitsTableShortCol::copy_data(const GFitsTableCol& column)
{
    // Type-cast to the correct column type
    const GFitsTableShortCol* ptr = static_cast<const GFitsTableShortCol*>(&column);
