/***************************************************************************
 *     GFitsImageUShort.cpp  - FITS unsigned short integer image class     *
 * ----------------------------------------------------------------------- *
 ...
 ***************************************************************************/
/**
 * @file GFitsImageUShort.cpp
 * @brief FITS unsigned short integer image class implementation
 * @author J. Knodlseder
 */
...
#define G_BITPIX 20                 //!< Defines the number of bits per pixel
 ...
 ***************************************************************************/
GFitsImageUShort::GFitsImageUShort(int nx, const unsigned short* pixels) :
 ...
 ***************************************************************************/
GFitsImageUShort::GFitsImageUShort(int nx, int ny, const unsigned short* pixels) :
 ...
 ***************************************************************************/
GFitsImageUShort::GFitsImageUShort(int nx, int ny, int nz,
 ...
 ***************************************************************************/
GFitsImageUShort::GFitsImageUShort(int nx, int ny, int nz, int nt,
                                   const unsigned short* pixels) :
 ...
 * @param[in] pixels Optional pointer to image pixel array
 *
 * Construct instance of GFitsImageUShort by specifying the image dimension and
 * the number of pixels in each dimension. Note that this constructor does
 * not allocate any memory for the actual image.
 ***************************************************************************/
GFitsImageUShort::GFitsImageUShort(int naxis, const int* naxes,
                                   const unsigned short* pixels) :
 ...
 ***************************************************************************/
unsigned short& GFitsImageUShort::operator() (const int& ix, const int& iy)
{
...
{
    // If image pixels are not available then fetch them now
    if (m_pixels == NULL) ((GFitsImageUShort*)this)->fetch_data();
 ...
 * checking and image dimension verification is required.
 ***************************************************************************/
const unsigned short& GFitsImageUShort::operator() (const int& ix, const int& iy) const
{
    // If image pixels are not available then allocate them now
    if (m_pixels == NULL) ((GFitsImageUShort*)this)->fetch_data();
 ...
 * checking and image dimension verification is required.
 ***************************************************************************/
const unsigned short& GFitsImageUShort::operator() (const int& ix, const int& iy,
                                                    const int& iz) const
{
    // If image pixels are not available then allocate them now
    if (m_pixels == NULL) ((GFitsImageUShort*)this)->fetch_data();
 ...
 ***************************************************************************/
unsigned short& GFitsImageUShort::at(const int& ix, const int& iy)
{
    // If image pixels are not available then allocate them now
    if (m_pixels == NULL) fetch_data();
 ...
 * Provides access to a pixel of an image including range checking.
 ***************************************************************************/
unsigned short& GFitsImageUShort::at(const int& ix, const int& iy, const int& iz)
{
    // If image pixels are not available then allocate them now
    if (m_pixels == NULL) fetch_data();
 ...
 * Provides access to a pixel of an image including range checking.
 ***************************************************************************/
const unsigned short& GFitsImageUShort::at(const int& ix, const int& iy) const
{
    // If image pixels are not available then allocate them now
    if (m_pixels == NULL) ((GFitsImageUShort*)this)->fetch_data();
 ...
 * Provides access to a pixel of an image including range checking.
 ***************************************************************************/
const unsigned short& GFitsImageUShort::at(const int& ix, const int& iy,
                                           const int& iz) const
{
    // If image pixels are not available then allocate them now
    if (m_pixels == NULL) ((GFitsImageUShort*)this)->fetch_data();
 ...
 * value. This method performs range checking.
 ***************************************************************************/
double GFitsImageUShort::pixel(const int& ix, const int& iy) const
{
    // Return pixel value
 ...
 * value. This method performs range checking.
 ***************************************************************************/
double GFitsImageUShort::pixel(const int& ix, const int& iy, const int& iz) const
{
    // Return pixel value
 ...
 * value. This method performs range checking.
 ***************************************************************************/
double GFitsImageUShort::pixel(const int& ix, const int& iy, const int& iz,
                              const int& it) const
{
    // Return pixel value
...
{
    // Clone this image
    return new GFitsImageUShort(*this);
}
...
void GFitsImageUShort::copy_members(const GFitsImageUShort& image)
{
    ...
    if (not_loaded) ((GFitsImageUShort*)(&image))->fetch_data();
    ...
    if (not_loaded) ((GFitsImageUShort*)(&image))->release_data();
    #endif
