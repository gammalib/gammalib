/***************************************************************************
 *     GFitsTableUStCol.cpp  - FITS table unsigned short column class      *
 * ----------------------------------------------------------------------- *
...
#define G_STRING           "GFitsTableUStCol::string(const int&, const int&)"
#define G_REAL               "GFitsTableUStCol::real(const int&, const int&)"
#define G_INTEGER         "GFitsTableUStCol::integer(const int&, const int&)"
 ...
 * @brief Constructor
 ***************************************************************************/
GFitsTableUStCol::GFitsTableUStCol() : GFitsTableCol()
{
 ...
 ***************************************************************************/
GFitsTableUStCol::GFitsTableUStCol(const std::string& name,
                                   const int&         length,
                                   const int&         size)
 ...
 ***************************************************************************/
GFitsTableUStCol::GFitsTableUStCol(const GFitsTableUStCol& column)
 ...
 * @brief Destructor
 ***************************************************************************/
GFitsTableUStCol::~GFitsTableUStCol()
{
    // Free members
    free_members();
 ...
 ***************************************************************************/
GFitsTableUStCol& GFitsTableUStCol::operator= (const GFitsTableUStCol& column)
{
 ...
 * Use one of
 *   GFitsTableUStCol::string(ix,iy),
 *   GFitsTableUStCol::real(ix;iy) or
 *   GFitsTableUStCol::integer(ix;iy)
 * if range checking is required.
 ***************************************************************************/
unsigned short& GFitsTableUStCol::operator() (const int& row, const int& inx)
{
 ...
 * if range checking is required.
 ***************************************************************************/
const unsigned short& GFitsTableUStCol::operator() (const int& row, const int& inx)
                                           const
{
    // If data are not available then load them now
    if (m_data == NULL) ((GFitsTableUStCol*)this)->fetch_data();
 ...
 ***************************************************************************/
std::string GFitsTableUStCol::string(const int& row, const int& inx)
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();
 ...
 ***************************************************************************/
double GFitsTableUStCol::real(const int& row, const int& inx)
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();
 ...
 ***************************************************************************/
int GFitsTableUStCol::integer(const int& row, const int& inx)
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();
...
/***********************************************************************//**
 * @brief Return pointer to unsigned short integer column
 ***************************************************************************/
unsigned short* GFitsTableUStCol::data(void)
{
    return m_data;
}
 ...
 ***************************************************************************/
void GFitsTableUStCol::set_nullval(const unsigned short* value)
{
 ...
 ***************************************************************************/
void GFitsTableUStCol::init_members(void)
{
    // Initialise members
    m_type   = __TUSHORT;
    m_data   = NULL;
 ...
 ***************************************************************************/
void GFitsTableUStCol::copy_members(const GFitsTableUStCol& column)
{
    // Fetch column data if not yet fetched. The casting circumvents the
    // const correctness
    if (column.m_data == NULL)
        ((GFitsTableUStCol*)(&column))->fetch_data();
 ...
 ***************************************************************************/
void GFitsTableUStCol::free_members(void)
{
    // Free memory
 ...
 ***************************************************************************/
void GFitsTableUStCol::save(void)
{
    // Save column
    save_column();
 ...
 * @brief Clone column
 ***************************************************************************/
GFitsTableUStCol* GFitsTableUStCol::clone(void) const
{
    return new GFitsTableUStCol(*this);
}
 ...
 ***************************************************************************/
std::string GFitsTableUStCol::ascii_format(void) const
{
 ...
 ***************************************************************************/
std::string GFitsTableUStCol::binary_format(void) const
{
    // Initialize format string
    std::string format;
 ...
 ***************************************************************************/
void GFitsTableUStCol::alloc_data(void)
{
 ...
 ***************************************************************************/
void GFitsTableUStCol::init_data(void)
{
 ...
 ***************************************************************************/
void GFitsTableUStCol::fetch_data(void)
{
    // Save column
    load_column();
 ...
 ***************************************************************************/
std::ostream& operator<< (std::ostream& os, const GFitsTableUStCol& column)
{
