...
const unsigned long& GFitsTableULongCol::operator() (const int& row, const int& inx) const
{
    // If data are not available then load them now
    if (m_data == NULL) {
        const_cast<GFitsTableULongCol*>(this)->fetch_data();
    }
 ...
 ***************************************************************************/
std::string GFitsTableULongCol::string(const int& row, const int& inx) const
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();
 ...
 ***************************************************************************/
double GFitsTableULongCol::real(const int& row, const int& inx) const
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();
 ...
 ***************************************************************************/
int GFitsTableULongCol::integer(const int& row, const int& inx) const
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();
 ...
 ***************************************************************************/
void GFitsTableULongCol::insert(const int& rownum, const int& nrows)
{
    ...
    if (nrows > 0) {
        ...
        // the existing items
            ...
            unsigned long* new_data = new unsigned long[m_size];
            ...
            unsigned long* src = m_data;
            unsigned long* dst = new_data;
 ...
 * will be loaded into memory.
 ***************************************************************************/
void GFitsTableULongCol::remove(const int& rownum, const int& nrows)
{
    // Make sure that rownum is valid
    if (rownum < 0 || rownum >= m_length) {
 ...
 ***************************************************************************/
void GFitsTableULongCol::nulval(const unsigned long* value)
{
    // Allocate nul value
    alloc_nulval(value);
...
void GFitsTableULongCol::copy_members(const GFitsTableULongCol& column)
{
    ...
    if (not_loaded) {
        const_cast<GFitsTableULongCol*>(&column)->fetch_data();
    }
    ...
    if (not_loaded) {
        const_cast<GFitsTableULongCol*>(&column)->release_data();
    }
    #endif
 ...
 ***************************************************************************/
void GFitsTableULongCol::fetch_data(void) const
{
    // Save column (circumvent const correctness)
    const_cast<GFitsTableULongCol*>(this)->load_column();
 ...
 * copy constructor.
 ***************************************************************************/
void GFitsTableULongCol::copy_data(const GFitsTableCol& column)
{
    // Type-cast to the correct column type
    const GFitsTableULongCol* ptr = static_cast<const GFitsTableULongCol*>(&column);
