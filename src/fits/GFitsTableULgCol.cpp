/***************************************************************************
 *      GFitsTableULgCol.cpp  - FITS table unsigned long column class      *
 * ----------------------------------------------------------------------- *
...
#define G_STRING           "GFitsTableULgCol::string(const int&, const int&)"
#define G_REAL               "GFitsTableULgCol::real(const int&, const int&)"
#define G_INTEGER         "GFitsTableULgCol::integer(const int&, const int&)"
 ...
 * @brief Constructor
 ***************************************************************************/
GFitsTableULgCol::GFitsTableULgCol() : GFitsTableCol()
{
 ...
 ***************************************************************************/
GFitsTableULgCol::GFitsTableULgCol(const std::string& name,
                                   const int&         length,
                                   const int&         size)
 ...
 ***************************************************************************/
GFitsTableULgCol::GFitsTableULgCol(const GFitsTableULgCol& column) 
 ...
 * @brief Destructor
 ***************************************************************************/
GFitsTableULgCol::~GFitsTableULgCol()
{
    // Free members
    free_members();
 ...
 ***************************************************************************/
GFitsTableULgCol& GFitsTableULgCol::operator= (const GFitsTableULgCol& column)
{
 ...
 * Use one of
 *   GFitsTableULgCol::string(ix,iy),
 *   GFitsTableULgCol::real(ix;iy) or
 *   GFitsTableULgCol::integer(ix;iy)
 * if range checking is required.
 ***************************************************************************/
unsigned long& GFitsTableULgCol::operator() (const int& row, const int& inx)
{
 ...
 * if range checking is required.
 ***************************************************************************/
const unsigned long& GFitsTableULgCol::operator() (const int& row, const int& inx)
                                          const
{
    // If data are not available then load them now
    if (m_data == NULL) ((GFitsTableULgCol*)this)->fetch_data();
 ...
 ***************************************************************************/
std::string GFitsTableULgCol::string(const int& row, const int& inx)
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();
 ...
 ***************************************************************************/
double GFitsTableULgCol::real(const int& row, const int& inx)
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();
 ...
 ***************************************************************************/
int GFitsTableULgCol::integer(const int& row, const int& inx)
{
    // If data are not available then load them now
    if (m_data == NULL) fetch_data();
...
/***********************************************************************//**
 * @brief Return pointer to unsigned long integer column
 ***************************************************************************/
unsigned long* GFitsTableULgCol::data(void)
{
    return m_data;
}
 ...
 ***************************************************************************/
void GFitsTableULgCol::set_nullval(const unsigned long* value)
{
 ...
 ***************************************************************************/
void GFitsTableULgCol::init_members(void)
{
    // Initialise members
    m_type   = __TULONG;
    m_data   = NULL;
 ...
 ***************************************************************************/
void GFitsTableULgCol::copy_members(const GFitsTableULgCol& column)
{
    // Fetch column data if not yet fetched. The casting circumvents the
    // const correctness
    if (column.m_data == NULL)
        ((GFitsTableULgCol*)(&column))->fetch_data();
 ...
 ***************************************************************************/
void GFitsTableULgCol::free_members(void)
{
    // Free memory
 ...
 ***************************************************************************/
void GFitsTableULgCol::save(void)
{
    // Save column
    save_column();
 ...
 * @brief Clone column
 ***************************************************************************/
GFitsTableULgCol* GFitsTableULgCol::clone(void) const
{
    return new GFitsTableULgCol(*this);
}
 ...
 ***************************************************************************/
std::string GFitsTableULgCol::ascii_format(void) const
{
 ...
 ***************************************************************************/
std::string GFitsTableULgCol::binary_format(void) const
{
    // Initialize format string
    std::string format;
 ...
 ***************************************************************************/
void GFitsTableULgCol::alloc_data(void)
{
 ...
 ***************************************************************************/
void GFitsTableULgCol::init_data(void)
{
 ...
 ***************************************************************************/
void GFitsTableULgCol::fetch_data(void)
{
    // Save column
    load_column();
 ...
 ***************************************************************************/
std::ostream& operator<< (std::ostream& os, const GFitsTableULgCol& column)
{
