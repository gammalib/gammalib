 ...
 * loaded into memory.
 ***************************************************************************/
void GFitsTableFloatCol::insert(const int& row, const int& nrows)
{
 ...
 ***************************************************************************/
void GFitsTableFloatCol::remove(const int& row, const int& nrows)
{
    // Make sure that row is valid
    if (row < 0 || row >= m_length) {
 ...
 ***************************************************************************/
void GFitsTableFloatCol::resize_data(const int& index, const int& number)
{
    ...
    if (number != 0) {
        ...
        if (number < 0) {
            ...
            float* dst  = m_data + index;
            float* src  = m_data + left;
            int    num  = m_size - left;
            for (int i = 0; i < num; ++i) {
                *dst++ = *src++;
            }
