# -*- coding: utf-8 -*-
#
# GammaLib documentation build configuration file, created by
...
project = u'GammaLib'
copyright = u'2006-2019, GammaLib developers'
...
latex_documents = [
  ('contents', 'GammaLib.tex', u'GammaLib Documentation',
   u'GammaLib developers', 'manual'),
]
...
man_pages = [
    ('contents', 'gammalib', u'GammaLib Documentation',
     [u'GammaLib developers'], 1)
]
...
texinfo_documents = [
  ('contents', 'GammaLib', u'GammaLib Documentation',
   u'GammaLib developers', 'GammaLib', 'One line description of project.',
   'Miscellaneous'),
]
