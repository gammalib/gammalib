 ...
 * @param[in] eff Efficiency factor functor.
 ***************************************************************************/
std::ostream& operator<< (std::ostream& os, const GLATEfficiency& eff)
{
     // Write efficiency factor functor in output stream
    os << eff.print();
 ...
 * @param[in] eff Efficiency factor functor.
 ***************************************************************************/
GLog& operator<< (GLog& log, const GLATEfficiency& eff)
{
    // Write efficiency factor functor into logger
    log << eff.print();
