/***************************************************************************
 *                 GCTAAeff.cpp - CTA effective area base class            *
 * ----------------------------------------------------------------------- *
...
/**
 * @file GCTAAeff.hpp
 * @brief CTA effective area base class implementation
 ...
 ***************************************************************************/
void GCTAAeff::load(const std::string& filename)
{
    // Open FITS file
    GFits fits(filename);
 ...
 ***************************************************************************/
void GCTAAeff::save(const std::string& filename, bool clobber) const
{
    // Open FITS file
