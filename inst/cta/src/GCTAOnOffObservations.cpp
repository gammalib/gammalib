 ...
 * @brief ON/OFF Observations container class implementation
...
#define G_SET        "GCTAOnOffObservations::set(int&, GCTAOnOffObservation&)"
#define G_APPEND        "GCTAOnOffObservations::append(GCTAOnOffObservation&)"
#define G_INSERT  "GCTAOnOffObservations::insert(int&, GCTAOnOffObservation&)"
#define G_REMOVE                         "GCTAOnOffObservations::remove(int&)"
#define G_EXTEND       "GCTAOnOffObservations::extend(GCTAOnOffObservations&)"
 ...
 ***************************************************************************/
void GCTAOnOffObservations::remove(const int& index)
{
