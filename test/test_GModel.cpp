...
void TestGModel::test_diffuse_map(void)
{
    ...
    test_value(map_norm.eval(photon), 13069.7741687, 0.1, "Unexpected skymap intensity.");
    GXmlElement element;
    ...
    test_value(map_nonnorm.eval(photon), 13069.6002755, 0.1, "Unexpected skymap intensity.");
