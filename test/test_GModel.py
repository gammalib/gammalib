...
class Test(gammalib.GPythonTestSuite):
    ...
    def _test_pickeling(self):
        ...
        test_support._pickeling(self, gammalib.GModelSpatialDiffuseCube(cube, 2.0))
        test_support._pickeling(self, gammalib.GModelSpatialDiffuseMap(cube,2.0))
        test_support._pickeling(self, gammalib.GModelSpatialEllipticalDisk(dir,0.2,0.3,45.0))
        test_support._pickeling(self, gammalib.GModelSpatialEllipticalGauss(dir,0.2,0.3,45.0))
        test_support._pickeling(self, gammalib.GModelSpatialPointSource(ptsrc))
        test_support._pickeling(self, gammalib.GModelSpatialRadialDisk(dir,0.2))
        test_support._pickeling(self, gammalib.GModelSpatialRadialGauss(dir,0.2))
        #test_support._pickeling(self, gammalib.GModelSpatialRadialProfileDMBurkert())
        #test_support._pickeling(self, gammalib.GModelSpatialRadialProfileDMEinasto())
        #test_support._pickeling(self, gammalib.GModelSpatialRadialProfileDMZhao())
        test_support._pickeling(self, gammalib.GModelSpatialRadialProfileGauss(dir,0.2))
        test_support._pickeling(self, gammalib.GModelSpatialRadialShell(dir,0.3,0.1))
