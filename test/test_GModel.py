...
class Test(gammalib.GPythonTestSuite):
    ...
    def _test_pickeling(self):
        ...
        test_support.pickeling(self, gammalib.GModelSpatialDiffuseCube(cube, 2.0))
        test_support.pickeling(self, gammalib.GModelSpatialDiffuseMap(cube,2.0))
        ...
        test_support.pickeling(self, gammalib.GModelSpectralNodes(nodes))
