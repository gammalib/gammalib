/***************************************************************************
 *            GFitsTableBitCol.i - FITS table bit column class             *
 * ----------------------------------------------------------------------- *
 ...
 *
 * @brief FITS table bit column class
 ***************************************************************************/
...
%extend GFitsTableBitCol {
    bool __getitem__(int GTuple1D2D[]) {
    ...
    void __setitem__(int GTuple1D2D[], bool value) {
        if (GTuple1D2D[1] < 0 || GTuple1D2D[1] >= self->nrows()) {
